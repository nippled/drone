...
// Copyright (c) 2013 droneX144 developers
...
const string strMessageMagic = "droneX144 Signed Message:\n";
...
static const int64 nStartSubsidy = 4.2 * COIN;
static const int64 nMinSubsidy = 0.0001 * COIN;

int64 static GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = nStartSubsidy;
    if(nHeight < 10) {nSubsidy = 4000 * COIN;} // minimal rewards to prevent instamine
